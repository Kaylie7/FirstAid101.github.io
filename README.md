...
<head>
    ...
    <title>Nursing First Aid Guide</title>
    <style>
        body {
            font-family: Arial, sans-serif;
            line-height: 1.6;
            margin: 20px;background-color: #fdfde2;
        }
...
<div style="text-align:center;"><img style="width: 100%;" src="KM.png"></div>

<div style="text-align:center; marjin-top:40px;">
<a style="padding-right: 20px;"href="#">Home</a>
<a style="padding-right: 20px;"href="#">About</a>
<a style="padding-right: 20px;"href="#">References</a>
</div>

 <h1 style="font-size:100px; text-align:center;">FIRST AID 101</h1> 
 <h1 style="font-size:15px; text-align:center;">In times of unforeseen emergencies, the importance of first aid care becomes abundantly clear. Imagine being the crucial link between an incident and professional medical assistance, with the ability to preserve life, prevent further harm, and pave the way for recovery. In this website, we delve into the fundamental role of first aid as the initial response in emergency situations. It's not just a skill it's a vital bridge to professional medical care, with the power to shape outcomes and make a difference when every second counts.</h1>
<ol>
<div style="text-align:center;"><img style="width: 100%;" src="first.png"></div>
<h1 style="font-size:20px; text-align:center;">Here are the first aid steps that you need to know in order to provide care under all sorts of emergency situations.</h1> 


    <section>
        <b><h1 style="font-size:50px; text-align:center;">ABRASION</h1></b>
 <div style="text-align:center;"><img style="width: 50%;" src="abrasion.webp"></div>
        <p>For a abrasion or small cut, follow these first aid steps:</p>
        <ol>
            <b><li>Clean Hands.</b> Ensure your hands are clean to prevent introducing dirt or bacteria to the wound.</li>
            <b><li>Gently Rinse.</b> Rinse the abrasion gently with cool, running water to remove any debris or dirt from the wound.</li>
            <b><li>Mild Soap.</b> Use a mild soap to clean the area around the abrasion. Avoid getting soap directly into the wound.</li>
            <b><li>Pat Dry.</b> Pat the area dry with a clean cloth or sterile gauze. Avoid rubbing, as it can irritate the wound.</li>
<b><li>Cover with a Bandage.</b> If needed, cover the abrasion with a sterile bandage to protect it from further irritation and contaminants.</li>
        </ol>
        <b><p>Bandaging Technique:</b> Use a sterile adhesive bandage to cover the slit or small cut.</p>
    </section>
...
<b><li>Avoid Realignment.</b> Do not attempt to realign the fractured bone. Leave this to medical professionals to avoid further injury.</li>
